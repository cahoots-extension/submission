...
/**
 * Boots the RESTful API of the cahoots submission platform.
 *
 * @param {number} port
...
API.prototype.boot = function boot (port, host, callback) {
    ...
    function onListen (err) {
        if (err) {
            return callback(new VError(err, 'failed to start the RESTful API of the cahoots submission platform'));
        }
